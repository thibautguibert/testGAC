L'application n'utilise pas Expo mais directement react-native. Elle a été développée depuis un environnement unix (Ubuntu), l'application n'a donc pas pu être testée sur iOS.
